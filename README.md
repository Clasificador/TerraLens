...
* **Segmentación de Imagen:** Implementación de algoritmos GrabCut (OpenCV) para aislar el residuo del fondo, mejorando la precisión en superficies complejas.
...
* Miguel Hernandez Mendieta - https://github.com/MiguelHZ21
